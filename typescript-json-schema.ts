...
export class JsonSchemaGenerator {
        ...
        if (!asRef || !this.reffedDefinitions[fullTypeName]) {
            ...
            if (definition.type === undefined) {  // if users override the type, do not try to infer it
                if (typ.flags & ts.TypeFlags.Union) {
                    ...
                    this.getMethodDefinition(<ts.MethodDeclaration>node, definition);
                } else {
    ...
    private getMethodDefinition(declaration: ts.MethodDeclaration, definition: Definition): Definition {
        // console.log('heh', declaration);
